...
PLATFORM_HINTS = {
    ...
    "gewe": (
        ...
        "MEDIA:/absolute/path/to/file in your response. The gateway handles all platform-specific "
        "delivery details. Images are sent as photos, .silk audio as voice, and other files "
        "as downloadable documents. Do NOT discuss transport details with the user. Do NOT "
        "tell the user you lack file-sending capability; use MEDIA: syntax whenever file delivery "
        "is appropriate. If earlier conversation history says GeWe cannot send local media, treat "
        "that as stale. "
